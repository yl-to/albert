...
def main():
    ...
    parser.add_argument('--num_nodes', type=int, default=16, help='Number of nodes')
    parser.add_argument('--bucket_name', type=str, default='yuliu-dev-east')
    ...
    parser.add_argument('--max_steps', type=int, default=125000)
    # model
    ...
    parser.add_argument("--image_uri", type=str,
                        default='564829616587.dkr.ecr.us-east-1.amazonaws.com/hf_albert:albert')
